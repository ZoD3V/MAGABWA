    ...
    <section id="Featured" class="mt-[30px]">
        <div class="main-carousel w-full">
            ...
            <div class="featured-news-card relative w-full h-[550px] flex shrink-0 overflow-hidden">
                <img src="{{ Storage::url($article->thumbnail) }}" class="thumbnail absolute w-full h-full object-cover"
                    alt="icon" />
        ...
        <div class="flex justify-between items-center h-fit">
            ...
            <div class="flex justify-between items-center h-fit">
                ...
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    <!-- Gambar dengan ukuran proporsional, menggunakan object-cover agar tetap mengisi container -->
                    ...
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a href="{{ route('front.details', $entertainment_featured_articles->slug) }}"
                                ...
                                {{-- Membatasi panjang judul menjadi 30 karakter dan menambahkan "..." jika melebihi --}}
                                {{ \Str::limit($entertainment_featured_articles->name, 35, '...') }}
                            </a>
                            <p class="text-white">
                ...
                @else
                <p>No featured entertainment articles available.</p>
                @endif
            </div>
                    ...
                    <a href="{{ route('front.details', $article->slug) }}" class="card py-[2px]">
                        <div
                            ...
                            <div class="flex flex-col justify-center gap-[6px]">
                                <h3 class="font-bold text-lg leading-[27px]">
                                    {{ Str::limit($article->name, 50) }}{{ strlen($article->name) > 50 ? '...' : '' }}
                                </h3>
                                <p class="text-sm leading-[21px] text-[#A3A6AE]">
                                    {{ $article->created_at->format('M d, Y') }}
                                </p>
